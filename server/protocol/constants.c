...
data_keys_s attribs[] = {
  ...
  DBP_KEY (DBP_ATTRIBNAME_SECRET, DBP_ATTRIB_PASSWORD),
...
enum dbp_attribs_enum dbp_call_asserts[DBP_ACTIONS_COUNT][DBP_ATTRIBS_COUNT] = {
  // ACTION_CREATE
  {DBP_ATTRIB_ACTION, DBP_ATTRIB_CRC, DBP_ATTRIB_FILENAME, DBP_ATTRIB_USERNAME, DBP_ATTRIB_PASSWORD},
  {DBP_ATTRIB_ACTION, DBP_ATTRIB_FILENAME, DBP_ATTRIB_USERNAME, DBP_ATTRIB_PASSWORD} // ACTION_DELETE
  ,
  {DBP_ATTRIB_ACTION} // ACTION_NOTIFICATION
  ,
  {DBP_ATTRIB_ACTION, DBP_ATTRIB_USERNAME, DBP_ATTRIB_PASSWORD} // ACTION_REQUEST
  ,
  ...
  {DBP_ATTRIB_ACTION,
   ...
   DBP_ATTRIB_USERNAME,
   DBP_ATTRIB_PASSWORD} // ACTION_UPDATE
};

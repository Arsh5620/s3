...
char *
string_internal_svprintf (char *string, va_list list, long *length, boolean alloc_debug)
{
    long size = 0;
    char *pointer = NULL;
...
char *
string_svprintf (char *string, va_list list, long *length)
{
    return (string_internal_svprintf (string, list, length, TRUE));
}

char *
string_svprintf2 (char *string, va_list list, long *length)
{
    return (string_internal_svprintf (string, list, length, FALSE));
}

char *
string_sprintf (char *string, long *length, ...)
{
    va_list args;
...
char *
string_sprintf2 (char *string, long *length, ...)
{
    va_list args;
    va_start (args, length);
...
void
string_tolower (char *memory, ulong length)
{
...
string_s
string_new_copy (char *data, ulong length)
{
    string_s string;

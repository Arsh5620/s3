...
#define DATABASE_COMMON_BIND_STMT(x) "SELECT * FROM " x " LIMIT 1"

#define DATABASE_COMMON_TABLE_EXISTS(x) "SELECT COUNT(*) AS 'table' FROM " x

#define DATABASE_CREATE_DATABASE "CREATE DATABASE IF NOT EXISTS " DATABASE_DB_NAME

#define DATABASE_CREATE_TABLE(x, y) "CREATE TABLE IF NOT EXISTS " x " ( " y " );"
...
database_table_bind_s
database_bind_select_copy (database_table_bind_s bind_table, string_s *columns, int count);
void

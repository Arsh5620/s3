...
#define MEMORY_ALIGNMENT	sizeof(__m128)
#define ALLOCATE_ALIGNMENT(x)	((x & MEMORY_ALIGNMENT) ? (x + 16) & ~MEMORY_ALIGNMENT: x)
...
ff_t poly_evaluate(ff_table_s table, poly_s poly, short evaluate_at);
size_t poly_add(ff_table_s table, poly_s *result, poly_s poly_a, poly_s poly_b);
